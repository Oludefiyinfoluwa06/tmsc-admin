      ...
      <div className="fixed right-4 bottom-6 z-50 flex flex-col gap-3">
        {toasts.map((t, i) => (
          <div
            ...
            className={`px-4 py-2 rounded shadow-lg text-sm max-w-xs text-white flex items-center space-x-3 ${t.type==='success'? 'bg-linear-to-r from-green-600 to-green-500' : t.type==='error'? 'bg-linear-to-r from-red-700 to-red-600' : 'bg-gray-800'}`}>
